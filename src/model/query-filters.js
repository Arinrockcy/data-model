...
export default class QueryFilter {
  ...
  /**
   * @param {object} model - The model object used for querying.
   * @param {object} filter - The filter object containing field name, value, and comparator.
   * @param {string} filterType - The type of filter for the given domain.
   */
  ...
  /**
   * Sets the column name used for filtering.
   * @param {string} columnName - The name of the column or field.
   */
